  ...
  useEffect(() => {
    const fetchContestData = async () => {
        ...
        setContest({
            ...
            prizes: [
            { rank: "รางวัลชนะเลิศ", reward: "10,000 บาท + โล่เกียรติยศ + Banner โปรโมท 1 เดือน" },
            { rank: "รางวัลรองชนะเลิศ", reward: "5,000 บาท + Certificate" },
            { rank: "รางวัลขวัญใจนักอ่าน", reward: "5,000 บาท (ตัดสินจากยอด Engagement)" }
            ],
